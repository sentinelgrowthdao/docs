...
/* harmony export */   dyte_video_grid: () => (/* binding */ DyteVideoGrid)
/* harmony export */ });
...
/* harmony import */ var _index_6873e729_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(90362);
...
/* harmony import */ var _grid_cfa3c02f_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(75673);
...
const DyteAudioGrid = class {
  constructor(hostRef) {
    ...
    this.onParticipantListUpdate = () => {
      ...
      let onStageParticipants = this.meeting.participants.joined.toArray();
      if (!this.hideSelf) {
        onStageParticipants = [...onStageParticipants, this.meeting.self];
      }
  ...
  renderGrid(participants = []) {
    ...
    return participants.map((participant) => {
      return ((0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_6873e729_js__WEBPACK_IMPORTED_MODULE_6__.R, { element: "dyte-audio-tile", defaults: defaults, props: {
          key: participant.id,
          participant,
        }, childProps: {
          participant,
  ...
  render() {
    return ((0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "content scrollbar" }, (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "stage grid" }, this.renderGrid(this.onStageParticipants)), this.offStageParticipants.length > 0 && ((0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "waitlist-area" }, (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "listening-title" }, this.offStageParticipants.length, " ", this.t('grid.listening')), (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "waitlist-grid grid" }, this.renderGrid(this.offStageParticipants))))), (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", null)));
  }
...
const DyteVideoGrid = class {
  constructor(hostRef) {
    ...
    this.eventCallback = (event) => {
      ...
      if (event === _pipStore_5d9dd8bf_js__WEBPACK_IMPORTED_MODULE_1__.P.CAMERA) {
      ...
      if (event === _pipStore_5d9dd8bf_js__WEBPACK_IMPORTED_MODULE_1__.P.MIC) {
      ...
      if (event === _pipStore_5d9dd8bf_js__WEBPACK_IMPORTED_MODULE_1__.P.END) {
        _pipStore_5d9dd8bf_js__WEBPACK_IMPORTED_MODULE_1__.s.cleanup();
    ...
    this.enablePipMediaControls = (meeting = this.meeting) => {
      ...
      if (canProduceAudio)
        _pipStore_5d9dd8bf_js__WEBPACK_IMPORTED_MODULE_1__.s.mountAudioEvents(this.eventCallback);
      if (canProduceVideo)
        _pipStore_5d9dd8bf_js__WEBPACK_IMPORTED_MODULE_1__.s.mountVideoEvents(this.eventCallback);
    };
    this.disablePipMediaControls = () => {
      _pipStore_5d9dd8bf_js__WEBPACK_IMPORTED_MODULE_1__.s.unmountAudioEvents();
      _pipStore_5d9dd8bf_js__WEBPACK_IMPORTED_MODULE_1__.s.unmountVideoEvents();
    };
    ...
    this.onSelfVideoUpdateListener = ({ videoEnabled }) => {
      _pipStore_5d9dd8bf_js__WEBPACK_IMPORTED_MODULE_1__.s.updateMediaSession(_pipStore_5d9dd8bf_js__WEBPACK_IMPORTED_MODULE_1__.P.CAMERA, videoEnabled);
    };
    this.onSelfAudioUpdateListener = ({ audioEnabled }) => {
      _pipStore_5d9dd8bf_js__WEBPACK_IMPORTED_MODULE_1__.s.updateMediaSession(_pipStore_5d9dd8bf_js__WEBPACK_IMPORTED_MODULE_1__.P.MIC, audioEnabled);
    };
    ...
    this.gap = 8;
    this.size = undefined;
    this.states = _store_56e792d0_js__WEBPACK_IMPORTED_MODULE_8__.s;
    this.config = _default_ui_config_a4308f1c_js__WEBPACK_IMPORTED_MODULE_7__.d;
    this.iconPack = _default_icon_pack_c36061c1_js__WEBPACK_IMPORTED_MODULE_3__.d;
    this.t = (0,_index_78bd00d9_js__WEBPACK_IMPORTED_MODULE_4__.u)();
    this.gridSize = _grid_cfa3c02f_js__WEBPACK_IMPORTED_MODULE_9__.d;
    this.overrides = {};
  }
  connectedCallback() {
    this.meetingChanged(this.meeting);
  ...
  screenShareParticipantsChanged(participants) {
    ...
    _store_56e792d0_js__WEBPACK_IMPORTED_MODULE_8__.s.activeScreenShare = activeScreenShare;
  }
  pluginsChanged(plugins) {
    const activePlugin = plugins.length > 0;
    this.stateUpdate.emit({ activePlugin });
    _store_56e792d0_js__WEBPACK_IMPORTED_MODULE_8__.s.activePlugin = activePlugin;
  }
  pinnedParticipantsChanged(participants) {
    const activeSpotlight = participants.length > 0;
    this.stateUpdate.emit({ activeSpotlight });
    _store_56e792d0_js__WEBPACK_IMPORTED_MODULE_8__.s.activeSpotlight = activeSpotlight;
  }
  ...
  updateLiveStreamStage() {
    this.showLiveStreamPlayer = (0,_livestream_8c64d895_js__WEBPACK_IMPORTED_MODULE_2__.a)(this.meeting);
  }
  meetingChanged(meeting, oldMeeting) {
    ...
    if (meeting != null) {
      ...
      this.pipSupported = _pipStore_5d9dd8bf_js__WEBPACK_IMPORTED_MODULE_1__.s.isSupported() && ((_a = meeting.self.config) === null || _a === void 0 ? void 0 : _a.pipMode);
      if (this.pipSupported) {
        const onReady = () => { };
        const onStop = () => {
          this.stateUpdate.emit({ activePipMode: false });
        };
        _pipStore_5d9dd8bf_js__WEBPACK_IMPORTED_MODULE_1__.s.create(onReady, onStop, this.eventCallback);
      ...
      const localStates = this.states || _store_56e792d0_js__WEBPACK_IMPORTED_MODULE_8__.s;
      // correct PiP state
      if (_pipStore_5d9dd8bf_js__WEBPACK_IMPORTED_MODULE_1__.s.isSupported() && localStates.activePipMode !== isEnabled) {
  ...
  render() {
    const defaults = {
      meeting: this.meeting,
      size: this.size,
      states: this.states || _store_56e792d0_js__WEBPACK_IMPORTED_MODULE_8__.s,
      config: this.config,
      iconPack: this.iconPack,
      t: this.t,
    };
    ...
    if (this.showLiveStreamPlayer) {
      return ((0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-livestream-player", { meeting: this.meeting, size: this.size }), (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-livestream-indicator", { meeting: this.meeting, size: "sm", t: this.t }), (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-viewer-count", { meeting: this.meeting, variant: "embedded", t: this.t })));
    }
    return ((0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_6873e729_js__WEBPACK_IMPORTED_MODULE_6__.R, { element: "dyte-grid", defaults: defaults, childProps: {
      ...
      }, onlyChildren: true }), (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-livestream-indicator", { meeting: this.meeting, size: "sm", t: this.t }), (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-viewer-count", { meeting: this.meeting, variant: "embedded" })));
  }
  static get watchers() { return {
...
DyteVideoGrid.style = dyteVideoGridCss;
