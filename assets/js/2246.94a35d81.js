...
/* harmony import */ var _size_8c675fd1_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(26985);
/* harmony import */ var _index_83532c35_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(74710);
/* harmony import */ var _default_ui_config_e1146f58_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(9367);
/* harmony import */ var _index_b65e08b5_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(67341);
...
/* harmony import */ var _ResizeObserver_es_02979d4e_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(36677);
/* harmony import */ var _default_icon_pack_c36061c1_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(68753);
/* harmony import */ var _isObjectLike_0d1a05d5_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(9079);
/* harmony import */ var _breakout_rooms_34bb7ea2_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(52732);
/* harmony import */ var _flags_ef1a782f_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(2079);
/* harmony import */ var _graceful_storage_33bc316d_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(60804);
...
const DyteMeeting = class {
  constructor(hostRef) {
    ...
    this.roomJoinedListener = () => {
      ...
      _store_6692f2d0_js__WEBPACK_IMPORTED_MODULE_8__.s.meeting = 'joined';
    };
    ...
    this.waitlistedListener = () => {
      ...
      _store_6692f2d0_js__WEBPACK_IMPORTED_MODULE_8__.s.meeting = 'waiting';
    };
    this.roomLeftListener = ({ state: state$1 }) => {
      const states = this.states || _store_6692f2d0_js__WEBPACK_IMPORTED_MODULE_8__.s;
      if ((states === null || states === void 0 ? void 0 : states.roomLeftState) === 'disconnected') {
        this.setStates({ meeting: 'ended', roomLeftState: state$1 });
        _store_6692f2d0_js__WEBPACK_IMPORTED_MODULE_8__.s.meeting = 'ended';
        return;
      }
      this.setStates({ meeting: 'ended', roomLeftState: state$1 });
      _store_6692f2d0_js__WEBPACK_IMPORTED_MODULE_8__.s.meeting = 'ended';
      _store_6692f2d0_js__WEBPACK_IMPORTED_MODULE_8__.s.roomLeftState = state$1;
    };
    this.mediaPermissionUpdateListener = ({ kind, message }) => {
      if (['audio', 'video'].includes(kind)) {
        if (message === 'ACCEPTED' || _store_6692f2d0_js__WEBPACK_IMPORTED_MODULE_8__.s.activeDebugger)
          return;
        ...
        _store_6692f2d0_js__WEBPACK_IMPORTED_MODULE_8__.s.activePermissionsMessage = permissionModalSettings;
      }
    };
    this.joinStateAcceptedListener = () => {
      this.setStates({ activeJoinStage: true });
      this.stateUpdate.emit({ activeJoinStage: true });
      _store_6692f2d0_js__WEBPACK_IMPORTED_MODULE_8__.s.activeJoinStage = true;
    };
    ...
    this.config = _default_ui_config_e1146f58_js__WEBPACK_IMPORTED_MODULE_4__.d;
    ...
    this.iconPack = _default_icon_pack_c36061c1_js__WEBPACK_IMPORTED_MODULE_10__.d;
  }
  connectedCallback() {
    var _a;
    this.resizeObserver = new _ResizeObserver_es_02979d4e_js__WEBPACK_IMPORTED_MODULE_9__.i(() => this.handleResize());
  ...
  meetingChanged(meeting) {
    ...
    if (this.loadConfigFromPreset && meeting.self.config != null) {
      ...
      const { config, data } = (0,_config_4706ae3f_js__WEBPACK_IMPORTED_MODULE_1__.s)(theme, meeting);
      if (this.config === _default_ui_config_e1146f58_js__WEBPACK_IMPORTED_MODULE_4__.d) {
      ...
      if (meeting.connectedMeetings.supportsConnectedMeetings &&
        ((_a = _store_6692f2d0_js__WEBPACK_IMPORTED_MODULE_8__.s.activeBreakoutRoomsManager) === null || _a === void 0 ? void 0 : _a.destinationMeetingId)) {
    ...
    if (meeting.self.roomJoined) {
      ...
      if (this.showSetupScreen && this.newMeeting == null) {
        ...
        _store_6692f2d0_js__WEBPACK_IMPORTED_MODULE_8__.s.meeting = 'setup';
      }
      else {
  ...
  async iconPackUrlChanged(url) {
    this.iconPack = await (0,_size_8c675fd1_js__WEBPACK_IMPORTED_MODULE_2__.g)(url);
  }
  listenState(e) {
    e.stopPropagation();
  ...
  initializePreferences() {
    const prefs = (0,_user_prefs_f52d234f_js__WEBPACK_IMPORTED_MODULE_7__.g)();
    this.setStates({ prefs });
    _store_6692f2d0_js__WEBPACK_IMPORTED_MODULE_8__.s.prefs = prefs;
  }
  handleChangingMeeting(destinationMeetingId) {
    _store_6692f2d0_js__WEBPACK_IMPORTED_MODULE_8__.s.activeBreakoutRoomsManager = Object.assign(Object.assign({}, _store_6692f2d0_js__WEBPACK_IMPORTED_MODULE_8__.s.activeBreakoutRoomsManager), { destinationMeetingId });
  }
  handleResize() {
    this.size = (0,_size_8c675fd1_js__WEBPACK_IMPORTED_MODULE_2__.a)(this.host.clientWidth);
  }
  setStates(states) {
    const newStates = Object.assign({}, this.states);
    (0,_config_4706ae3f_js__WEBPACK_IMPORTED_MODULE_1__.w)(newStates, states);
  ...
  render() {
    ...
    const defaults = {
      ...
      size: this.size,
      states: this.states || _store_6692f2d0_js__WEBPACK_IMPORTED_MODULE_8__.s,
      config: this.config,
    ...
    if (((_c = (_b = this.meeting) === null || _b === void 0 ? void 0 : _b.meta) === null || _c === void 0 ? void 0 : _c.viewType) === 'CHAT')
      return (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_b65e08b5_js__WEBPACK_IMPORTED_MODULE_5__.R, { element: "dyte-chat", defaults: defaults });
    return (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_b65e08b5_js__WEBPACK_IMPORTED_MODULE_5__.R, { element: "dyte-meeting", defaults: defaults, asHost: true, elementProps: elementProps });
  }
