...
/* harmony import */ var _ChatHead_b5faacbe_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(54515);
...
const DyteAiTranscriptions = class {
  ...
  connectedCallback() {
    ...
    (_b = (_a = this.meeting) === null || _a === void 0 ? void 0 : _a.meta) === null || _b === void 0 ? void 0 : _b.on('transcript', (data) => this.transcriptionHandler(data));
  }
  disconnectedCallback() {
    var _a, _b;
    (_b = (_a = this.meeting) === null || _a === void 0 ? void 0 : _a.meta) === null || _b === void 0 ? void 0 : _b.off('transcript', (data) => this.transcriptionHandler(data));
  }
  ...
  render() {
    return ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "search-bar" }, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("input", { type: "text", placeholder: "Search Participant", value: this.participantQuery, onInput: (e) => (this.participantQuery = e.target.value) })), this.isProcessing && ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "processing" }, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("p", null, "Processing audio...."))), !this.isProcessing && ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "content scrollbar", ref: (el) => (this.contentContainer = el) }, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "started-message" }, "Transcription started"), this.transcriptions
      .filter((t) => this.participantQuery
      ? t.name.toLowerCase().includes(this.participantQuery.toLowerCase())
      : true)
      .map((transcription) => ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "message" }, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)(_ChatHead_b5faacbe_js__WEBPACK_IMPORTED_MODULE_2__.C, { name: transcription.name, time: new Date(transcription.date), now: new Date() }), (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "body" }, transcription.transcript)))))), this.captionViewEnabled && (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-ai-caption", null)));
  }
