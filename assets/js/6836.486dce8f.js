...
/* harmony import */ var _debounce_d1d72dac_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(11029);
/* harmony import */ var _isObjectLike_0d1a05d5_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(9079);
...
const DyteMessageListView = class {
  constructor(hostRef) {
    ...
    this.updateTotalHeight = (0,_debounce_d1d72dac_js__WEBPACK_IMPORTED_MODULE_4__.d)(() => {
  ...
  render() {
    return ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "scrollbar content-wrapper", ref: (el) => (this.$listRef = el), onScroll: this.handleScroll }, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "scroller" }, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { style: {
        height: `${this.totalHeight}px`,
      } }), (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "smallest-dom-element", id: "list-end", ref: (el) => (this.$listEndRef = el) })), (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "content", style: {
        transform: `translateY(${this.getRangeSize(0, this.range.start)}px)`,
      } }, this.isFetching && ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "loader" }, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-spinner", { size: "md" }))), this.getVisibleItems().map((msg, index) => ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { key: msg.id, ref: (el) => this.rendererInternal(el, msg, index) }))))));
  }
