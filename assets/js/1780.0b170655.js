...
const DyteSettingsAudio = class {
  ...
  setDevice(kind, deviceId) {
    var _a, _b;
    if ((0,_flags_fc3b9ebe_js__WEBPACK_IMPORTED_MODULE_5__.d)(this.meeting))
      return;
  ...
  render() {
    ...
    })), (0,_index_926e26e8_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-audio-visualizer", { participant: (_b = this.meeting) === null || _b === void 0 ? void 0 : _b.self, iconPack: this.iconPack, t: this.t })))), (0,_index_926e26e8_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "group", part: "speaker-selection" }, this.speakerDevices.length > 0 && !(0,_flags_fc3b9ebe_js__WEBPACK_IMPORTED_MODULE_5__.d)(this.meeting) && ((0,_index_926e26e8_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", null, (0,_index_926e26e8_js__WEBPACK_IMPORTED_MODULE_0__.h)("label", null, this.t('settings.speaker_output')), (0,_index_926e26e8_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "row" }, (0,_index_926e26e8_js__WEBPACK_IMPORTED_MODULE_0__.h)("select", { class: "dyte-select", onChange: (e) => this.setDevice('speaker', e.target.value) }, this.speakerDevices.map(({ deviceId, label }) => {
      var _a;
