...
/* harmony import */ var _flags_fc3b9ebe_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(81195);
/* harmony import */ var _sidebar_0506d53e_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(8541);
...
const DyteChatToggle = class {
  constructor(hostRef) {
    ...
    this.updateCanView = () => {
      this.canViewChat = (0,_sidebar_0506d53e_js__WEBPACK_IMPORTED_MODULE_5__.c)(this.meeting);
    };
    this.unreadMessageCount = 0;
    this.variant = 'button';
  ...
  meetingChanged(meeting) {
    ...
    if (meeting == null)
      return;
    if ((0,_flags_fc3b9ebe_js__WEBPACK_IMPORTED_MODULE_4__.u)(meeting)) {
    ...
    this.canViewChat = (0,_sidebar_0506d53e_js__WEBPACK_IMPORTED_MODULE_5__.c)(meeting);
  ...
  render() {
    if (!this.canViewChat)
      return;
    return ((0,_index_926e26e8_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_926e26e8_js__WEBPACK_IMPORTED_MODULE_0__.H, { title: this.t('chat') }, (0,_flags_fc3b9ebe_js__WEBPACK_IMPORTED_MODULE_4__.u)(this.meeting)
...
const canViewParticipants = (meeting) => {
  ...
  if ((0,_livestream_1a40fc8d_js__WEBPACK_IMPORTED_MODULE_0__.s)(meeting) && !((_b = meeting.self.permissions) === null || _b === void 0 ? void 0 : _b.acceptStageRequests))
    return false;
