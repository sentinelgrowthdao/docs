...
const DyteLivestreamIndicator = class {
  ...
  render() {
    if (!(0,_livestream_1a40fc8d_js__WEBPACK_IMPORTED_MODULE_1__.s)(this.meeting) || !this.isLivestreaming)
      return;
    return ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "indicator", "aria-label": this.t('livestream.indicator'), part: "indicator" }, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.start_livestream, size: this.size }), (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("span", null, this.t('LIVE')))));
  }
...
const DyteLivestreamPlayer = class {
  constructor(hostRef) {
    ...
    this.getLoadingState = () => {
      ...
      switch (this.livestreamState) {
        ...
        case 'STOPPING':
          ...
          break;
        case 'LIVESTREAMING':
          if (this.playerState !== _livestream_1a40fc8d_js__WEBPACK_IMPORTED_MODULE_1__.P.PLAYING) {
            loadingMessage = this.t('livestream.starting');
            showIcon = true;
            isLoading = true;
          }
    ...
    this.playerState = _livestream_1a40fc8d_js__WEBPACK_IMPORTED_MODULE_1__.P.IDLE;
  ...
  AddPlayerListeners(player = this.ivsPlayer) {
    Object.values(Object.assign(Object.assign({}, _livestream_1a40fc8d_js__WEBPACK_IMPORTED_MODULE_1__.b), _livestream_1a40fc8d_js__WEBPACK_IMPORTED_MODULE_1__.P)).forEach((key) => {
      if (_livestream_1a40fc8d_js__WEBPACK_IMPORTED_MODULE_1__.c.includes(key))
        return;
      player === null || player === void 0 ? void 0 : player.addEventListener(key, (event) => {
        var _a, _b, _c;
        if (key === _livestream_1a40fc8d_js__WEBPACK_IMPORTED_MODULE_1__.P.IDLE ||
          key === _livestream_1a40fc8d_js__WEBPACK_IMPORTED_MODULE_1__.P.PLAYING ||
          key === _livestream_1a40fc8d_js__WEBPACK_IMPORTED_MODULE_1__.b.ERROR ||
          key === _livestream_1a40fc8d_js__WEBPACK_IMPORTED_MODULE_1__.P.READY)
          this.playerState = key;
        if (key === _livestream_1a40fc8d_js__WEBPACK_IMPORTED_MODULE_1__.b.ERROR) {
          this.playerError = event;
        }
        if (key === _livestream_1a40fc8d_js__WEBPACK_IMPORTED_MODULE_1__.P.IDLE && player.isPaused()) {
          player.play();
        }
        if (key === _livestream_1a40fc8d_js__WEBPACK_IMPORTED_MODULE_1__.b.AUDIO_BLOCKED) {
        ...
        if (_livestream_1a40fc8d_js__WEBPACK_IMPORTED_MODULE_1__.d.includes(key)) {
  ...
  onPlayerRef(el) {
    this.player = el;
    this.meeting.participants.pip.addSource('livestream-player', this.player, this.playbackUrl ? true : false);
    if (this.playbackUrl)
      this.meeting.participants.pip.enableSource('livestream-player');
  }
  ...
  render() {
    if (!(0,_livestream_1a40fc8d_js__WEBPACK_IMPORTED_MODULE_1__.s)(this.meeting))
      return;
    const { isError, errorMessage } = this.getErrorState();
    const { isLoading, loadingMessage, showIcon } = this.getLoadingState();
    return ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "player-container" }, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("video", { ref: (el) => this.onPlayerRef(el), playsInline: true }), this.audioPlaybackError && ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "unmute-popup" }, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("h3", null, this.t('audio_playback.title')), (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("p", null, this.t('audio_playback.description')), (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { kind: "wide", onClick: () => {
        this.player.muted = false;
        this.audioPlaybackError = false;
      }, title: this.t('audio_playback'), iconPack: this.iconPack, t: this.t }, this.t('audio_playback')))), this.livestreamState === 'LIVESTREAMING' && this.showLatencyIndicator && ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "latency-controls" })), isError && ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "loader" }, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.warning, t: this.t }), (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("p", null, errorMessage))), !isError && isLoading && ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "loader" }, showIcon && ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-spinner", { id: "icon", part: "spinner", iconPack: this.iconPack, t: this.t, size: "md" })), (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("p", null, loadingMessage))))));
  }
  static get watchers() { return {
    "meeting": ["meetingChanged"]
  }; }
...
const DyteViewerCount = class {
  ...
  render() {
    if (!(0,_livestream_1a40fc8d_js__WEBPACK_IMPORTED_MODULE_1__.s)(this.meeting))
      return null;
    return ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.H, { tabIndex: 0, role: "log", "aria-label": `${this.viewerCount} ${this.t('viewers')}` }, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.viewers, tabIndex: -1, "aria-hidden": true, part: "icon", iconPack: this.iconPack, t: this.t }), this.viewerCount, " ", this.t('viewers')));
  }
  static get watchers() { return {
    "meeting": ["meetingChanged"]
  }; }
