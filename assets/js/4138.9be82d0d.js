...
/* harmony import */ var _flags_d0561f1f_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(24942);
...
const DyteChatToggle = class {
  constructor(hostRef) {
    ...
    this.toggleChat = () => {
      ...
      _store_56e792d0_js__WEBPACK_IMPORTED_MODULE_3__.s.sidebar = this.chatActive ? 'chat' : undefined;
    ...
    this.updateCanView = () => {
      this.canViewChat = (0,_sidebar_4555d4ae_js__WEBPACK_IMPORTED_MODULE_5__.c)(this.meeting);
    };
    this.unreadMessageCount = 0;
    this.variant = 'button';
  ...
  meetingChanged(meeting) {
    ...
    if (meeting == null)
      return;
    if ((0,_flags_d0561f1f_js__WEBPACK_IMPORTED_MODULE_4__.u)(meeting)) {
    ...
    this.canViewChat = (0,_sidebar_4555d4ae_js__WEBPACK_IMPORTED_MODULE_5__.c)(meeting);
  ...
  render() {
    if (!this.canViewChat)
      return;
    return ((0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.H, { title: this.t('chat') }, (0,_flags_d0561f1f_js__WEBPACK_IMPORTED_MODULE_4__.u)(this.meeting)
