...
/* harmony import */ var _default_ui_config_a4308f1c_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(86020);
...
const DyteParticipantTile = class {
  constructor(hostRef) {
    ...
    this.config = _default_ui_config_a4308f1c_js__WEBPACK_IMPORTED_MODULE_6__.d;
    this.variant = 'solid';
    this.size = undefined;
  ...
  participantsChanged(participant) {
    if (participant == undefined || this.meeting == undefined)
      return;
    const { self } = this.meeting;
    this.videoState = {
  ...
  videoStateChanged(videoState) {
    ...
    if (videoState != null && this.videoEl != null) {
      if (videoState.videoEnabled) {
        if ((_a = this.meeting) === null || _a === void 0 ? void 0 : _a.__internals__.features.hasFeature(_flags_d0561f1f_js__WEBPACK_IMPORTED_MODULE_5__.F.LOG_PLAYING_FAILURES)) {
          if (this.playTimeout)
            clearTimeout(this.playTimeout);
  ...
  render() {
    ...
    return ((0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)("video", { ref: (el) => this.onVideoRef(el), class: {
        ...
        var _a, _b;
        if (this.isSelf() &&
          ((_a = this.meeting) === null || _a === void 0 ? void 0 : _a.__internals__.features.hasFeature(_flags_d0561f1f_js__WEBPACK_IMPORTED_MODULE_5__.F.PLAY_PARTICIPANT_TILE_VIDEO_ON_PAUSE))) {
