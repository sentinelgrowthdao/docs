...
const DyteDebuggerToggle = class {
  ...
  toggleDebugger() {
    ...
    _store_6692f2d0_js__WEBPACK_IMPORTED_MODULE_3__.s.activeDebugger = !_store_6692f2d0_js__WEBPACK_IMPORTED_MODULE_3__.s.activeDebugger;
  ...
  render() {
    ...
    if (!((_a = this.meeting) === null || _a === void 0 ? void 0 : _a.troubleshoot))
      return;
    return ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.H, { title: this.t('Network & Trouble Shooting') }, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-controlbar-button", { size: this.size, iconPack: this.iconPack, t: this.t, onClick: () => this.toggleDebugger(), icon: this.iconPack.debug, label: this.t('Troubleshooting and Help'), variant: this.variant })));
  }
};
