...
/* harmony import */ var _default_ui_config_a4308f1c_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(86020);
...
/* harmony import */ var _default_icon_pack_c36061c1_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(68753);
...
/* harmony import */ var _breakout_rooms_a66f96cd_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(16413);
/* harmony import */ var _flags_d0561f1f_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(24942);
...
const DyteUiProvider = class {
  constructor(hostRef) {
    ...
    this.size = undefined;
    this.config = _default_ui_config_a4308f1c_js__WEBPACK_IMPORTED_MODULE_2__.d;
    ...
    this.joinRoom = true;
    this.isReady = false;
    this.iconPack = _default_icon_pack_c36061c1_js__WEBPACK_IMPORTED_MODULE_6__.d;
  }
  ...
  async meetingChanged(meeting) {
    ...
    if (this.loadConfigFromPreset && meeting.self.config != null) {
      ...
      const { config } = (0,_config_693a8ea2_js__WEBPACK_IMPORTED_MODULE_1__.g)(theme, meeting);
      if (this.config === _default_ui_config_a4308f1c_js__WEBPACK_IMPORTED_MODULE_2__.d) {
        // only override the config if the object is same as defaultConfig
        // which means it's a different object passed via prop
        this.config = Object.assign(Object.assign(Object.assign({}, _default_ui_config_a4308f1c_js__WEBPACK_IMPORTED_MODULE_2__.d), config), { designTokens: Object.assign(Object.assign({}, _default_ui_config_a4308f1c_js__WEBPACK_IMPORTED_MODULE_2__.d.designTokens), config.designTokens) });
      }
    }
