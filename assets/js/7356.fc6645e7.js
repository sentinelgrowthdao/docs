...
const DyteAi = class {
  constructor(hostRef) {
    ...
    this.close = () => {
      ...
      _store_6692f2d0_js__WEBPACK_IMPORTED_MODULE_5__.s.activeAI = false;
    };
  ...
  connectedCallback() {
    ...
    // this.middlewares?.speech?.on('chatGPTReply', this.aiMessageHandler);
  }
  disconnectedCallback() {
    ...
    // this.middlewares?.speech?.off('chatGPTReply', this.aiMessageHandler);
  }
  viewChanged(view) {
    if (view === 'full-screen') {
  ...
  viewSection(section) {
    this.tab = section;
    _store_6692f2d0_js__WEBPACK_IMPORTED_MODULE_5__.s.activeSidebar = true;
  }
  ...
  render() {
    ...
    return ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("h3", { class: "title" }, this.t('ai')), (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { id: "mobile-header" }, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { variant: "ghost", class: { active: this.tab === 'home' }, onClick: () => this.viewSection('home'), iconPack: this.iconPack, t: this.t }, this.t('ai.home'), this.newAiMessageAvailable && (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("span", { class: "dot" }, ".")), (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { variant: "ghost", class: { active: this.tab === 'transcriptions' }, onClick: () => this.viewSection('transcriptions'), iconPack: this.iconPack, t: this.t }, this.t('ai.transcriptions'), this.newTranscriptionAvailable && (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("span", { class: "dot" }, "."))), (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { variant: "ghost", kind: "icon", class: "close", onClick: this.close, "aria-label": this.t('close'), iconPack: this.iconPack, t: this.t }, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.dismiss, iconPack: this.iconPack, t: this.t })), this.tab === 'home' && ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_b65e08b5_js__WEBPACK_IMPORTED_MODULE_3__.R, { element: "dyte-ai-home", defaults: defaults, props: {
        // aiClient: aiClient,
        // initialMessages: aiClient.aiMesssages,
        meeting: this.meeting,
      } })), this.tab === 'transcriptions' && ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_b65e08b5_js__WEBPACK_IMPORTED_MODULE_3__.R, { element: "dyte-ai-transcriptions", defaults: defaults })), this.tab === 'personal' && (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_b65e08b5_js__WEBPACK_IMPORTED_MODULE_3__.R, { element: "dyte-ai-chat", defaults: defaults })));
  }
