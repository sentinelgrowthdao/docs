...
/* harmony import */ var _config_693a8ea2_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(58019);
...
/* harmony import */ var _default_ui_config_a4308f1c_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(86020);
/* harmony import */ var _index_6873e729_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(90362);
...
/* harmony import */ var _breakout_rooms_a66f96cd_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(16413);
/* harmony import */ var _flags_d0561f1f_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(24942);
...
const DyteMeeting = class {
  constructor(hostRef) {
    ...
    this.mediaPermissionUpdateListener = ({ kind, message }) => {
      if (['audio', 'video'].includes(kind)) {
        if (message === 'ACCEPTED' || _store_56e792d0_js__WEBPACK_IMPORTED_MODULE_7__.s.activeDebugger)
          return;
    ...
    this.config = _default_ui_config_a4308f1c_js__WEBPACK_IMPORTED_MODULE_4__.d;
  ...
  connectedCallback() {
    ...
    if (this.applyDesignSystem &&
      ...
      (0,_config_693a8ea2_js__WEBPACK_IMPORTED_MODULE_1__.p)(document.documentElement, this.config.designTokens);
    }
  ...
  meetingChanged(meeting) {
    ...
    if (this.loadConfigFromPreset && meeting.self.config != null) {
      ...
      const { config, data } = (0,_config_693a8ea2_js__WEBPACK_IMPORTED_MODULE_1__.g)(theme, meeting);
      if (this.config === _default_ui_config_a4308f1c_js__WEBPACK_IMPORTED_MODULE_4__.d) {
  ...
  setStates(states) {
    ...
    (0,_config_693a8ea2_js__WEBPACK_IMPORTED_MODULE_1__.m)(newStates, states);
  ...
  render() {
    ...
    if (((_c = (_b = this.meeting) === null || _b === void 0 ? void 0 : _b.meta) === null || _c === void 0 ? void 0 : _c.viewType) === 'CHAT')
      return (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_6873e729_js__WEBPACK_IMPORTED_MODULE_5__.R, { element: "dyte-chat", defaults: defaults });
    return (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_6873e729_js__WEBPACK_IMPORTED_MODULE_5__.R, { element: "dyte-meeting", defaults: defaults, asHost: true, elementProps: elementProps });
  }
