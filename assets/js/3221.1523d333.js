...
/* harmony import */ var _index_78bd00d9_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8934);
...
/* harmony import */ var _breakout_rooms_a66f96cd_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(16413);
...
class DraftStateManager {
  ...
  addNewMeeting() {
    ...
    const _a = (0,_breakout_rooms_a66f96cd_js__WEBPACK_IMPORTED_MODULE_4__.a)(), meeting = __rest(_a, ["participants"]);
  ...
  updateMeetingTitle(meetingId, newTitle) {
    ...
    if (!(0,_breakout_rooms_a66f96cd_js__WEBPACK_IMPORTED_MODULE_4__.i)(meetingId)) {
  ...
  deleteMeeting(meetingId) {
    __classPrivateFieldSet(this, _DraftStateManager_hasLocalChanges, true, "f");
    const meeting = __classPrivateFieldGet(this, _DraftStateManager_allMeetingsMap, "f").get(meetingId);
    const participants = __classPrivateFieldGet(this, _DraftStateManager_instances, "m", _DraftStateManager_getMeetingParticipants).call(this, meeting.id).map(_breakout_rooms_a66f96cd_js__WEBPACK_IMPORTED_MODULE_4__.p);
    ...
    if (!(0,_breakout_rooms_a66f96cd_js__WEBPACK_IMPORTED_MODULE_4__.i)(meeting.id)) {
  ...
  assignParticipantsRandomly() {
    const splits = (0,_breakout_rooms_a66f96cd_js__WEBPACK_IMPORTED_MODULE_4__.s)(this.unassignedParticipants, this.allConnectedMeetings.length);
  ...
  unassignAllParticipants() {
    const destinationMeetingId = __classPrivateFieldGet(this, _DraftStateManager_state, "f").parentMeeting.id;
    const customParticipantIds = this.allParticipants.map(_breakout_rooms_a66f96cd_js__WEBPACK_IMPORTED_MODULE_4__.p);
    return this.assignParticipantsToMeeting(customParticipantIds, destinationMeetingId);
  }
  /**
  ...
  get meetingsToCreate() {
    return this.allConnectedMeetings
      .filter((meeting) => (0,_breakout_rooms_a66f96cd_js__WEBPACK_IMPORTED_MODULE_4__.i)(meeting.id))
...
_DraftStateManager_hasLocalChanges = new WeakMap(), _DraftStateManager_state = new WeakMap(), _DraftStateManager_participantsNewMeetingMap = new WeakMap(), _DraftStateManager_participantsOldMeetingMap = new WeakMap(), _DraftStateManager_meetingParticipantsMap = new WeakMap(), _DraftStateManager_allParticipantsMap = new WeakMap(), _DraftStateManager_allMeetingsMap = new WeakMap(), _DraftStateManager_meetingsToUpdate = new WeakMap(), _DraftStateManager_meetingsToDelete = new WeakMap(), _DraftStateManager_instances = new WeakSet(), _DraftStateManager_init = function _DraftStateManager_init(state) {
  ...
  __classPrivateFieldGet(this, _DraftStateManager_state, "f").parentMeeting.participants.forEach((participant) => {
    __classPrivateFieldGet(this, _DraftStateManager_participantsOldMeetingMap, "f").set((0,_breakout_rooms_a66f96cd_js__WEBPACK_IMPORTED_MODULE_4__.p)(participant), __classPrivateFieldGet(this, _DraftStateManager_state, "f").parentMeeting.id);
  });
  __classPrivateFieldGet(this, _DraftStateManager_state, "f").meetings.forEach((meeting) => {
    meeting.participants.forEach((participant) => {
      __classPrivateFieldGet(this, _DraftStateManager_participantsOldMeetingMap, "f").set((0,_breakout_rooms_a66f96cd_js__WEBPACK_IMPORTED_MODULE_4__.p)(participant), meeting.id);
    });
  });
  ...
  if (__classPrivateFieldGet(this, _DraftStateManager_allParticipantsMap, "f").has((0,_breakout_rooms_a66f96cd_js__WEBPACK_IMPORTED_MODULE_4__.p)(participant))) {
    return;
  }
  __classPrivateFieldGet(this, _DraftStateManager_allParticipantsMap, "f").set((0,_breakout_rooms_a66f96cd_js__WEBPACK_IMPORTED_MODULE_4__.p)(participant), participant);
  __classPrivateFieldGet(this, _DraftStateManager_participantsNewMeetingMap, "f").set((0,_breakout_rooms_a66f96cd_js__WEBPACK_IMPORTED_MODULE_4__.p)(participant), meeting.id);
  __classPrivateFieldGet(this, _DraftStateManager_meetingParticipantsMap, "f").get(meeting.id).add((0,_breakout_rooms_a66f96cd_js__WEBPACK_IMPORTED_MODULE_4__.p)(participant));
...
const DyteBreakoutRoomsManager = class {
  constructor(hostRef) {
    ...
    this.updateLocalState = (payload) => {
      ...
      if (this.roomConfig.mode === 'create' && !this.meeting.connectedMeetings.isActive) {
        (0,_breakout_rooms_a66f96cd_js__WEBPACK_IMPORTED_MODULE_4__.r)();
      }
    ...
    this.t = (0,_index_78bd00d9_js__WEBPACK_IMPORTED_MODULE_1__.u)();
  }
  ...
  onParticipantDelete(event) {
    const { detail } = event;
    const id = (0,_breakout_rooms_a66f96cd_js__WEBPACK_IMPORTED_MODULE_4__.p)(detail);
    if (id == null)
      return;
    this.unassignParticipant(id);
  }
  ...
  async joinRoom(destinationMeetingId) {
    const participantId = (0,_breakout_rooms_a66f96cd_js__WEBPACK_IMPORTED_MODULE_4__.p)(this.meeting.self);
