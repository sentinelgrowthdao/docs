...
const DytePluginsToggle = class {
  constructor(hostRef) {
    ...
    this.updateCanView = () => {
      this.canViewPlugins = (0,_sidebar_4555d4ae_js__WEBPACK_IMPORTED_MODULE_4__.b)(this.meeting);
    };
    this.variant = 'button';
  ...
  meetingChanged(meeting) {
    ...
    if (meeting == null)
      return;
    this.canViewPlugins = (0,_sidebar_4555d4ae_js__WEBPACK_IMPORTED_MODULE_4__.b)(meeting);
  ...
  togglePlugins() {
    ...
    _store_56e792d0_js__WEBPACK_IMPORTED_MODULE_3__.s.sidebar = this.pluginsActive ? 'plugins' : undefined;
