...
const DyteChatToggle = class {
  constructor(hostRef) {
    ...
    this.toggleChat = () => {
      ...
      _store_6692f2d0_js__WEBPACK_IMPORTED_MODULE_3__.s.activeSidebar = this.chatActive;
      _store_6692f2d0_js__WEBPACK_IMPORTED_MODULE_3__.s.activeMoreMenu = false;
      _store_6692f2d0_js__WEBPACK_IMPORTED_MODULE_3__.s.sidebar = this.chatActive ? 'chat' : undefined;
    ...
    this.updateCanView = () => {
      this.canViewChat = (0,_sidebar_24d819c8_js__WEBPACK_IMPORTED_MODULE_5__.c)(this.meeting);
    };
    this.unreadMessageCount = 0;
    this.variant = 'button';
  ...
  meetingChanged(meeting) {
    ...
    if (meeting == null)
      return;
    if ((0,_flags_ef1a782f_js__WEBPACK_IMPORTED_MODULE_4__.u)(meeting)) {
    ...
    this.canViewChat = (0,_sidebar_24d819c8_js__WEBPACK_IMPORTED_MODULE_5__.c)(meeting);
  ...
  render() {
    if (!this.canViewChat)
      return;
    return ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.H, { title: this.t('chat') }, (0,_flags_ef1a782f_js__WEBPACK_IMPORTED_MODULE_4__.u)(this.meeting)
      ? this.hasNewMessages && (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "unread-count-dot", part: "unread-count-dot" })
      : this.unreadMessageCount !== 0 &&
        !this.chatActive && ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "unread-count", part: "unread-count" }, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("span", null, this.unreadMessageCount <= 100 ? this.unreadMessageCount : '99+'))), (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-controlbar-button", { part: "controlbar-button", size: this.size, iconPack: this.iconPack, t: this.t, class: { active: this.chatActive }, onClick: this.toggleChat, icon: this.iconPack.chat, label: this.t('chat'), variant: this.variant })));
  }
