...
const DyteLivestreamToggle = class {
  constructor(hostRef) {
    ...
    this.livestreamStateListener = (state$1) => {
      ...
      if (state$1 === 'LIVESTREAMING' || state$1 === 'IDLE') {
        ...
        _store_6692f2d0_js__WEBPACK_IMPORTED_MODULE_4__.s.activeMoreMenu = false;
      }
    };
    this.isLoading = () => {
  ...
  render() {
    if (!(0,_livestream_1a40fc8d_js__WEBPACK_IMPORTED_MODULE_3__.i)(this.meeting))
      return;
    return ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-controlbar-button", { part: "controlbar-button", size: this.size, iconPack: this.iconPack, t: this.t, isLoading: this.isLoading(), class: { 'active-livestream': this.livestreamState === 'LIVESTREAMING' }, onClick: () => this.toggleLivestream(), icon: this.getLivestreamIcon(), disabled: this.isLoading(), label: this.t(this.getLivestreamLabel()), variant: this.variant })));
  }
