...
const DyteChannelCreator = class {
  constructor(hostRef) {
    ...
    this.switchChannel = (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.c)(this, "switchChannel", 7);
    ...
    this.createChannel = async () => {
      ...
      _store_6692f2d0_js__WEBPACK_IMPORTED_MODULE_5__.s.activeChannelCreator = false;
    };
    this.onMemberAdd = (id) => {
    ...
    this.keyDownHandler = (e, filteredMembers) => {
      if (e.key === 'ArrowDown') {
        ...
        (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.f)(this.$el);
      }
    };
    this.renderMemberSelector = () => {
      ...
      return ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "input-container" }, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("ul", { class: "members scrollbar", onClick: () => {
          var _a;
          (_a = this.searchInputTextRef) === null || _a === void 0 ? void 0 : _a.focus();
        } }, selectedMembers.map((member) => ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("li", { class: "pill" }, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-avatar", { participant: {
          name: member.name,
          picture: member.picture,
        }, size: "sm" }), (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("span", null, member.name), (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.dismiss, iconPack: this.iconPack, t: this.t, onClick: () => {
          this.selectedMemberIds.delete(member.userId);
          (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.f)(this.$el);
          this.focusOnSearch();
        } })))), !disableInput && ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("input", { type: "text", ref: (el) => (this.searchInputTextRef = el), value: this.searchQuery, placeholder: this.selectedMemberIds.size === 0 ? this.t('chat.member_name') : '', class: {
          'wide-input': this.selectedMemberIds.size === 0,
        }, onInput: (e) => {
          this.searchQuery = e.target.value.trim();
        }, onClick: () => {
          this.showAllMembersList = !this.showAllMembersList;
        }, onKeyDown: (e) => this.keyDownHandler(e, filteredMembers) }))), (this.searchQuery.length !== 0 || this.showAllMembersList) && ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("ul", { class: "search-results" }, filteredMembers.map((member, index) => ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("li", { class: { member: true, selected: index === this.focusedMemberIndex }, onClick: () => this.onMemberAdd(member.userId), ref: ($li) => {
          ...
          name: member.name,
          picture: member.picture,
        }, size: "sm" }), (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("span", null, member.name)))), filteredMembers.length === 0 && ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("li", { class: "member" }, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("span", null, this.t('chat.error.empty_results'))))))));
    };
  ...
  render() {
    return ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("header", null, this.step === 1 ? this.t('chat.new_channel') : this.t('chat.add_members')), this.step === 1 && ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("input", { class: "channel-name-input", type: "text", placeholder: this.t('chat.channel_name'), ref: (el) => (this.inputTextRef = el), onInput: (e) => {
        this.channelName = e.target.value.trim();
      } })), this.step === 2 && this.renderMemberSelector(), (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("footer", null, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { kind: "button", iconPack: this.iconPack, t: this.t, size: "lg", disabled: this.channelName.length === 0, onClick: this.onClickHandler }, this.step === 1 ? this.t('chat.add_members') : this.t('create')))));
  }
