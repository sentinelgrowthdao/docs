...
/* harmony import */ var _flags_fc3b9ebe_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(81195);
/* harmony import */ var _store_8f4d7acc_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(26468);
/* harmony import */ var _breakout_rooms_manager_f602d399_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(6302);
...
const DyteChat = class {
  constructor(hostRef) {
    ...
    this.usePaginatedChat = () => {
      if (this.isGroupCall && this.showPinnedMessages)
        return false;
      return this.selectedGroup === 'everyone' && (0,_flags_fc3b9ebe_js__WEBPACK_IMPORTED_MODULE_5__.u)(this.meeting);
    };
  ...
  meetingChanged(meeting, oldMeeting) {
    ...
    if (meeting != null) {
      ...
      this.canPinMessages =
        ((_e = meeting === null || meeting === void 0 ? void 0 : meeting.__internals__) === null || _e === void 0 ? void 0 : _e.features.hasFeature(_flags_fc3b9ebe_js__WEBPACK_IMPORTED_MODULE_5__.F.PINNED_MESSAGES)) &&
  ...
  renderComposerUI() {
    ...
    return ((0,_index_926e26e8_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-chat-composer-view", Object.assign({ message: message, storageKey: (_a = this.selectedChannelId) !== null && _a !== void 0 ? _a : `draft-${this.selectedChannelId}`, quotedMessage: quotedMessage, isEditing: !!this.editingMessage, canSendTextMessage: this.isTextMessagingAllowed(), canSendFiles: this.isFileMessagingAllowed(), disableEmojiPicker: !!((_c = (_b = this.meeting) === null || _b === void 0 ? void 0 : _b.__internals__) === null || _c === void 0 ? void 0 : _c.features.hasFeature(_flags_fc3b9ebe_js__WEBPACK_IMPORTED_MODULE_5__.F.DISABLE_EMOJI_PICKER)), inputTextPlaceholder: this.t('chat.message_placeholder'), onNewMessage: this.onNewMessageHandler, onEditMessage: this.onEditMessageHandler, onEditCancel: this.onEditCancel, onQuotedMessageDismiss: this.onQuotedMessageDismiss }, uiProps), (0,_index_926e26e8_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", { name: "chat-addon", slot: "chat-addon" })));
  }
  renderFullChat() {
