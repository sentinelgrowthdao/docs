...
const DyteDebuggerAudio$1 = class {
  ...
  render() {
    ...
    return ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "text" }, this.t('Please select a prompt that best describes your issue')), (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("select", { class: `dyte-select ${this.issueIndex === 0 ? 'disabled' : ''}`, onChange: (e) => this.selectIssue(e.target.value) }, issues.map((issue) => ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("option", { value: issue.index }, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("span", null, issue.value))))), ((_c = (_b = issues[this.issueIndex]) === null || _b === void 0 ? void 0 : _b.steps) === null || _c === void 0 ? void 0 : _c.length) > 0 && ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "sub-title" }, this.t('How to fix this:'))), (_e = (_d = issues[this.issueIndex]) === null || _d === void 0 ? void 0 : _d.steps) === null || _e === void 0 ? void 0 :
      _e.map((step) => ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "recommendation" }, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", null, "\u2022"), this.t(step)))), ((_g = (_f = issues[this.issueIndex]) === null || _f === void 0 ? void 0 : _f.steps) === null || _g === void 0 ? void 0 : _g.length) > 0 &&
      (this.reported ? ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("p", { class: "report-link" }, this.t('Your issue has been reported.'))) : ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "report-issue" }, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("p", { class: "recommendation", ref: (el) => (this.reportEl = el) }, this.t('Still facing the issue?')), (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { size: "sm", variant: "secondary", onClick: () => this.reportIssue() }, this.t('Report Now')))))));
  }
};
  ...
  render() {
    ...
    const devices = this.mediaType === 'audio'
      ...
      : this.mediaType === 'video'
        ? ['Camera']
        : [];
    return ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("h3", null, "Device Permissions"), (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: `info ${this.permission}` }, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { size: "sm", icon: this.iconPack[permission.icon] }), permission.info), (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "text" }, permission.text), this.permission === 'ACCEPTED' && devices.length > 0 && ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "device-indicator" }, devices.map((device) => {
      var _a;
      return ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "device" }, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "label" }, "Active ", device), (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "seperator" }, ":"), (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "device-name" }, (_a = this.devices[device]) === null || _a === void 0 ? void 0 : _a.label)));
    }), (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "text" }, this.t('You can change the active devices from settings.')))), steps.length > 0 && (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "sub-title" }, this.t('How to fix this:')), steps === null || steps === void 0 ? void 0 :
      steps.map((step) => ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "recommendation" }, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", null, "\u2022"), this.t(step)))), image !== '' && ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("video", { src: `https://cdn.dyte.in/assets/permissions/${image}`, autoPlay: true, muted: true, loop: true })), this.mediaType !== 'screenshare' && this.permission === 'NOT_REQUESTED' && ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { onClick: () => this.allowPermission() }, "Allow Device Permission"))));
  }
...
const DyteInformationTooltip = class {
  ...
  render() {
    return ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "tooltip-container" }, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.info, size: "sm" }), (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "tooltip" }, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", { name: "tootlip-text" })))));
  }
};
