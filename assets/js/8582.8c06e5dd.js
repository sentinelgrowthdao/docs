...
/* harmony import */ var _config_fd091649_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(63654);
...
/* harmony import */ var _livestream_8216e2d1_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(26786);
...
/* harmony import */ var _breakout_rooms_607110c8_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(50057);
/* harmony import */ var _flags_e3703792_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(54956);
...
const DyteMeeting = class {
  constructor(hostRef) {
    ...
    this.mediaPermissionUpdateListener = ({ kind, message }) => {
      if (['audio', 'video'].includes(kind)) {
        console.log(message, _store_8f4d7acc_js__WEBPACK_IMPORTED_MODULE_6__.s.activeDebugger);
        if ((message === 'DENIED' || message === 'SYSTEM_DENIED') &&
          _store_8f4d7acc_js__WEBPACK_IMPORTED_MODULE_6__.s.activeDebugger !== true) {
  ...
  connectedCallback() {
    ...
    if (this.applyDesignSystem &&
      ...
      (0,_config_fd091649_js__WEBPACK_IMPORTED_MODULE_1__.p)(document.documentElement, this.config.designTokens);
    }
  ...
  meetingChanged(meeting) {
    ...
    if (this.loadConfigFromPreset && meeting.self.config != null) {
      ...
      const { config, data } = (0,_config_fd091649_js__WEBPACK_IMPORTED_MODULE_1__.g)(theme, meeting);
      if (this.config === _default_ui_config_85a764ac_js__WEBPACK_IMPORTED_MODULE_4__.d) {
  ...
  setStates(states) {
    ...
    (0,_config_fd091649_js__WEBPACK_IMPORTED_MODULE_1__.m)(newStates, states);
