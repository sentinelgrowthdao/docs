...
/* harmony import */ var _index_fcbfb3a0_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(59990);
...
const DyteParticipantTile = class {
  constructor(hostRef) {
    ...
    this.onPause = (event) => {
      var _a, _b;
      if (this.isSelf() &&
        ((_a = this.meeting) === null || _a === void 0 ? void 0 : _a.__internals__.features.hasFeature(_flags_fc3b9ebe_js__WEBPACK_IMPORTED_MODULE_4__.F.PLAY_PARTICIPANT_TILE_VIDEO_ON_PAUSE))) {
    ...
    this.t = (0,_index_fcbfb3a0_js__WEBPACK_IMPORTED_MODULE_3__.u)();
  }
  onVideoRef(el) {
    this.videoEl = el;
  ...
  connectedCallback() {
    ...
    if (this.states === undefined) {
      ...
      this.removeStateChangeListener = (0,_store_8f4d7acc_js__WEBPACK_IMPORTED_MODULE_1__.o)('prefs', () => (0,_index_926e26e8_js__WEBPACK_IMPORTED_MODULE_0__.f)(this));
    }
  }
  componentDidLoad() {
  ...
  videoStateChanged(videoState) {
    ...
    if (videoState != null && this.videoEl != null) {
      if (videoState.videoEnabled) {
        if ((_a = this.meeting) === null || _a === void 0 ? void 0 : _a.__internals__.features.hasFeature(_flags_fc3b9ebe_js__WEBPACK_IMPORTED_MODULE_4__.F.LOG_PLAYING_FAILURES)) {
          if (this.playTimeout)
            clearTimeout(this.playTimeout);
