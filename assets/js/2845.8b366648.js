...
/* harmony import */ var _flags_fc3b9ebe_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(81195);
...
const DyteBreakoutRoomsManager = class {
  constructor(hostRef) {
    ...
    this.updateLocalState = (payload) => {
      ...
      if (this.roomConfig.mode === 'create' && !this.meeting.connectedMeetings.isActive) {
        (0,_breakout_rooms_50756495_js__WEBPACK_IMPORTED_MODULE_4__.r)();
      }
  ...
  connectedCallback() {
    ...
    this.stateManager = new _breakout_rooms_manager_f602d399_js__WEBPACK_IMPORTED_MODULE_5__.B();
    this.fetchRoomState();
  }
  ...
  onParticipantDelete(event) {
    const { detail } = event;
    const id = (0,_breakout_rooms_50756495_js__WEBPACK_IMPORTED_MODULE_4__.p)(detail);
    if (id == null)
      return;
    this.unassignParticipant(id);
  }
  ...
  async joinRoom(destinationMeetingId) {
    const participantId = (0,_breakout_rooms_50756495_js__WEBPACK_IMPORTED_MODULE_4__.p)(this.meeting.self);
