...
const DyteMoreToggle = class {
  constructor(hostRef) {
    ...
    this.handleKeyDown = ({ key }) => {
      if (key === 'Escape' && this.states.activeMoreMenu) {
        ...
        _store_6692f2d0_js__WEBPACK_IMPORTED_MODULE_3__.s.activeMoreMenu = !_store_6692f2d0_js__WEBPACK_IMPORTED_MODULE_3__.s.activeMoreMenu;
      }
    };
    ...
    this.toggleMoreMenu = () => {
      this.stateUpdate.emit({ activeMoreMenu: !_store_6692f2d0_js__WEBPACK_IMPORTED_MODULE_3__.s.activeMoreMenu });
      _store_6692f2d0_js__WEBPACK_IMPORTED_MODULE_3__.s.activeMoreMenu = !_store_6692f2d0_js__WEBPACK_IMPORTED_MODULE_3__.s.activeMoreMenu;
    };
  ...
  render() {
    ...
    return ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.H, { title: text }, this.states.activeMoreMenu && ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "more-menu" }, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", { name: "more-elements" }))), (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-controlbar-button", { size: this.size, iconPack: this.iconPack, t: this.t, onClick: (e) => {
        e.stopPropagation();
        this.toggleMoreMenu();
      }, icon: this.iconPack.horizontal_dots, label: text, part: "controlbar-button" }), (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", { name: "expanded" })));
  }
