...
/* harmony import */ var _index_b65e08b5_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(67341);
...
const DyteSetupScreen = class {
  constructor(hostRef) {
    ...
    this.states = _store_6692f2d0_js__WEBPACK_IMPORTED_MODULE_6__.s;
    this.size = undefined;
  ...
  meetingChanged(meeting) {
    ...
    if (meeting != null) {
      ...
      _store_6692f2d0_js__WEBPACK_IMPORTED_MODULE_6__.s.meeting = 'setup';
    }
  }
  render() {
    var _a, _b, _c, _d;
    ...
    const defaults = {
      ...
      config: this.config,
      states: this.states || _store_6692f2d0_js__WEBPACK_IMPORTED_MODULE_6__.s,
      size: this.size,
      iconPack: this.iconPack,
      t: this.t,
    };
    return ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "container" }, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_b65e08b5_js__WEBPACK_IMPORTED_MODULE_2__.R, { element: "dyte-participant-tile", defaults: defaults, props: { participant: (_b = this.meeting) === null || _b === void 0 ? void 0 : _b.self, size: 'md' }, childProps: { participant: (_c = this.meeting) === null || _c === void 0 ? void 0 : _c.self, size: 'md' }, deepProps: true }), (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "metadata" }, ((_d = this.displayName) === null || _d === void 0 ? void 0 : _d.trim()) === '' ? ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "name" }, this.t('setup_screen.join_in_as'))) : ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "label" }, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("p", null, this.t('setup_screen.joining_as')), (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "name" }, (0,_string_8aa800b0_js__WEBPACK_IMPORTED_MODULE_7__.s)(this.displayName, 20)))), this.canEditName && ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("input", { placeholder: this.t('setup_screen.your_name'), value: this.displayName, autoFocus: true, ref: (el) => {
        this.inputEl = el;
      }, onInput: (e) => {
      ...
      } })), (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { size: "lg", kind: "wide", onClick: this.join, disabled: disabled, iconPack: this.iconPack, t: this.t }, this.isJoining ? ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-spinner", { iconPack: this.iconPack, t: this.t })) : (this.t('join')))))));
  }
