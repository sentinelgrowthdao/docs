...
/* harmony import */ var _store_6692f2d0_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(39571);
...
const DyteParticipants = class {
  ...
  disconnectedCallback() {
    ...
    participants.joined.removeListener('stageStatusUpdate', this.getParticipants);
  ...
  render() {
    ...
    const defaults = {
      ...
      t: this.t,
      config: this.config,
      states: _store_6692f2d0_js__WEBPACK_IMPORTED_MODULE_7__.s,
      size: this.size,
      iconPack: this.iconPack,
    };
    return ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "participants-container" }, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "heading-count", part: "heading-count" }, this.t('participants'), " (", this.participants.length, ")"), (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("ul", { class: "participants", part: "participants" }, this.participants.map((participant) => ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_b65e08b5_js__WEBPACK_IMPORTED_MODULE_6__.R, { element: "dyte-participant", defaults: defaults, props: { role: 'listitem', participant }, childProps: Object.assign(Object.assign({}, defaults), { participant, size: this.size }), deepProps: true }))), this.participants.length === 0 && ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "empty-message", part: "empty-message" }, this.search.length > 0 ? this.t('search.could_not_find') : this.t('search.empty')))))));
  }
