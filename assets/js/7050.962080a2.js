...
const DytePollsToggle = class {
  constructor(hostRef) {
    ...
    this.updateCanView = () => {
      this.canViewPolls = (0,_sidebar_4555d4ae_js__WEBPACK_IMPORTED_MODULE_4__.d)(this.meeting);
    };
    this.variant = 'button';
  ...
  meetingChanged(meeting) {
    ...
    if (meeting && meeting.polls) {
      ...
      this.canViewPolls = (0,_sidebar_4555d4ae_js__WEBPACK_IMPORTED_MODULE_4__.d)(meeting);
  ...
  togglePollsTab() {
    ...
    _store_56e792d0_js__WEBPACK_IMPORTED_MODULE_3__.s.sidebar = this.pollsActive ? 'polls' : undefined;
