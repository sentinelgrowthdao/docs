...
const DyteMicToggle = class {
  constructor(hostRef) {
    ...
    this.toggleMic = () => {
      ...
      if (this.hasPermissionError()) {
        ...
        _store_6692f2d0_js__WEBPACK_IMPORTED_MODULE_3__.s.activePermissionsMessage = permissionModalSettings;
        return false;
      }
  ...
  updateCanProduce(meeting) {
    ...
    const isWebinar = meta.viewType === 'WEBINAR' || meeting.self.permissions.stageEnabled;
    const isLiveStream = meta.viewType === 'LIVESTREAM';
    this.canProduceAudio = false;
    if (canProduceAudio && !isLiveStream && !isWebinar) {
  ...
  render() {
    ...
    return ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.H, { title: label }, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-tooltip", { kind: "block", label: tooltipLabel, part: "tooltip", iconPack: this.iconPack, t: this.t }, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-controlbar-button", { part: "controlbar-button", icon: icon, label: label, size: this.size, iconPack: this.iconPack, t: this.t, variant: this.variant, class: classList, onClick: this.toggleMic, showWarning: showWarning, disabled: disable }))));
  }
