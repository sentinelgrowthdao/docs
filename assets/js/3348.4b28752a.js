...
const DytePolls = class {
  constructor(hostRef) {
    ...
    this.onVote = (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.c)(this, "dyteVotePoll", 7);
    this.poll = undefined;
    this.self = undefined;
  ...
  render() {
    ...
    return ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "ctr" }, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("p", { class: "poll-title" }, this.t('polls.by'), " ", (0,_string_8aa800b0_js__WEBPACK_IMPORTED_MODULE_3__.s)((0,_string_8aa800b0_js__WEBPACK_IMPORTED_MODULE_3__.f)(this.poll.createdBy), 20)), (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "poll" }, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("p", { class: "poll-question" }, this.poll.question), (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "poll-answers" }, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("span", null, this.t('polls.answers')), (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("span", null, this.poll.voted.length)), this.poll.options.map((item, index) => ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: {
        active: item.votes.some((x) => x.id === this.self),
        'open-vote': this.permissions.polls.canVote && !hasVoted,
        'poll-option': true,
      } }, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "poll-option-header", "data-disabled": !this.permissions.polls.canVote }, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("label", null, !hasVoted && ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("input", { disabled: !this.permissions.polls.canVote, readOnly: hasVoted, type: "radio", checked: item.votes.some((x) => x.id === this.self), onClick: (e) => this.vote(e, index) })), (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("p", null, item.text)), (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("span", { class: "counter" }, item.count)), (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "votes" }, item.votes.map((vote) => {
      if (this.poll.anonymous && this.self !== this.poll.createdByUserId)
        return;
      return ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-tooltip", { label: vote.name, iconPack: this.iconPack, t: this.t }, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "vote" }, (0,_string_8aa800b0_js__WEBPACK_IMPORTED_MODULE_3__.g)(vote.name))));
    })))))))));
  }
};
...
const DytePoll = class {
  constructor(hostRef) {
    (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.r)(this, hostRef);
    this.onCreate = (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.c)(this, "dyteCreatePoll", 7);
    this.iconPack = _default_icon_pack_c36061c1_js__WEBPACK_IMPORTED_MODULE_1__.d;
    this.t = (0,_index_83532c35_js__WEBPACK_IMPORTED_MODULE_2__.u)();
    this.options = ['', ''];
  ...
  render() {
    return ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "create-poll" }, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("p", null, this.t('polls.question')), (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("textarea", { onInput: () => {
        if (this.error && this.error.code === 0)
          this.error = undefined;
      }, ref: (e) => (this.question = e), placeholder: this.t('polls.question.placeholder') }), this.options.map((item, index) => ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "option" }, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("input", { placeholder: this.t('polls.option.placeholder'), value: item, onInput: (event) => this.updateOption(event, index) }), index > 1 && ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { kind: "icon", class: "auto remove-option", variant: "secondary", onClick: () => this.removeOption(index), iconPack: this.iconPack, t: this.t }, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.subtract, iconPack: this.iconPack, t: this.t })))))), (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { class: "add-option", variant: "secondary", onClick: () => this.addOption(), iconPack: this.iconPack, t: this.t }, this.t('polls.option')), (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("label", null, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("input", { id: "anonymous", type: "checkbox", onChange: (e) => (this.anonymous = e.target.checked) }), this.t('polls.results.anon')), (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("label", null, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("input", { id: "hideVotes", type: "checkbox", disabled: this.anonymous, checked: this.anonymous ? true : this.hideVotes, onChange: (e) => (this.hideVotes = e.target.checked) }), this.t('polls.results.hide')), (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { kind: "wide", onClick: () => this.handleSubmit(), iconPack: this.iconPack, t: this.t }, this.t('polls.create')), this.error && (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("span", { class: "error-text" }, this.error.message))));
  }
};
