...
/* harmony import */ var _default_ui_config_e1146f58_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(9367);
/* harmony import */ var _index_b65e08b5_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(67341);
/* harmony import */ var _store_6692f2d0_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(39571);
...
const DyteChatComposerView = class {
  constructor(hostRef) {
    ...
    this.inputTextPlaceholder = 'Enter you message';
...
const DyteDialogManager = class {
  constructor(hostRef) {
    ...
    this.onDyteDialogClose = (state$1, value) => {
      _store_6692f2d0_js__WEBPACK_IMPORTED_MODULE_10__.s[state$1] = value;
    ...
    this.meeting = undefined;
    this.config = _default_ui_config_e1146f58_js__WEBPACK_IMPORTED_MODULE_8__.d;
  ...
  render() {
    ...
    const defaults = {
      ...
      states: this.states || _store_6692f2d0_js__WEBPACK_IMPORTED_MODULE_10__.s,
      config: this.config,
      size: this.size,
      iconPack: this.iconPack,
      t: this.t,
    };
    const states = this.states || _store_6692f2d0_js__WEBPACK_IMPORTED_MODULE_10__.s;
    if ((states === null || states === void 0 ? void 0 : states.image) != null) {
      const image = states.image;
      const onImageClose = () => {
        this.stateUpdate.emit({ image: null });
        _store_6692f2d0_js__WEBPACK_IMPORTED_MODULE_10__.s.image = null;
      };
