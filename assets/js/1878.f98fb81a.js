...
/* harmony import */ var _sidebar_24d819c8_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(57419);
...
const DyteParticipantsToggle = class {
  constructor(hostRef) {
    ...
    this.updateCanView = () => {
      this.canViewParticipants = (0,_sidebar_24d819c8_js__WEBPACK_IMPORTED_MODULE_4__.a)(this.meeting);
    };
    this.variant = 'button';
  ...
  connectedCallback() {
    ...
    (0,_store_6692f2d0_js__WEBPACK_IMPORTED_MODULE_3__.o)('sidebar', () => this.statesChanged());
  }
  disconnectedCallback() {
    ...
    (_d = this.meeting.participants) === null || _d === void 0 ? void 0 : _d.joined.removeListener('stageStatusUpdate', this.updateStageRequests);
  }
  meetingChanged(meeting) {
    var _a;
    if (meeting == null)
      return;
    this.canViewParticipants = (0,_sidebar_24d819c8_js__WEBPACK_IMPORTED_MODULE_4__.a)(meeting);
    ...
    if (this.meeting.self.permissions.acceptPresentRequests) {
      ...
      meeting === null || meeting === void 0 ? void 0 : meeting.participants.joined.on('stageStatusUpdate', this.updateStageRequests);
    }
    this.updateBadgeCount();
  }
  statesChanged(s) {
    const states = s || _store_6692f2d0_js__WEBPACK_IMPORTED_MODULE_3__.s;
    if (states != null) {
      this.participantsActive = states.activeSidebar === true && states.sidebar === 'participants';
    }
  }
  toggleParticipantsTab() {
    const states = this.states || _store_6692f2d0_js__WEBPACK_IMPORTED_MODULE_3__.s;
    ...
    _store_6692f2d0_js__WEBPACK_IMPORTED_MODULE_3__.s.activeSidebar = this.participantsActive;
    _store_6692f2d0_js__WEBPACK_IMPORTED_MODULE_3__.s.sidebar = this.participantsActive ? 'participants' : undefined;
    ...
    _store_6692f2d0_js__WEBPACK_IMPORTED_MODULE_3__.s.activeMoreMenu = false;
  }
  render() {
    ...
    return ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.H, { title: text }, this.badgeCount !== 0 && !this.participantsActive && ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "waiting-participants-count", part: "waiting-participants-count" }, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("span", null, this.badgeCount <= 100 ? this.badgeCount : '99+'))), (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-controlbar-button", { part: "controlbar-button", size: this.size, iconPack: this.iconPack, t: this.t, class: { active: this.participantsActive }, onClick: () => this.toggleParticipantsTab(), icon: this.iconPack.participants, label: text, variant: this.variant })));
  }
