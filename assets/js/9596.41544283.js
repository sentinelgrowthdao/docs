...
/* harmony import */ var _breakout_rooms_50756495_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(55524);
...
/* harmony import */ var _breakout_rooms_manager_f602d399_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(6302);
...
const DyteBreakoutRoomManager = class {
  ...
  connectedCallback() {
    var _a;
    this.allParticipants = (0,_breakout_rooms_50756495_js__WEBPACK_IMPORTED_MODULE_3__.g)(this.meeting);
    this.permissionsUpdateListener();
  ...
  renderPeer(participant) {
    const { displayPictureUrl: picture } = this.allParticipants.find((p) => (0,_breakout_rooms_50756495_js__WEBPACK_IMPORTED_MODULE_3__.p)(p) === (0,_breakout_rooms_50756495_js__WEBPACK_IMPORTED_MODULE_3__.p)(participant));
...
const DyteBreakoutRoomParticipants = class {
  constructor(hostRef) {
    ...
    this.onClick = (participant) => {
      const selected = this.selectedParticipantIds.includes((0,_breakout_rooms_50756495_js__WEBPACK_IMPORTED_MODULE_3__.p)(participant));
      this.updateSelectedParticipants(participant, !selected);
    };
    this.onToggleAll = (checked) => {
      const selectedParticipants = checked ? this.participantsToShow.map(_breakout_rooms_50756495_js__WEBPACK_IMPORTED_MODULE_3__.p) : [];
  ...
  updateSelectedParticipants(participant, selected) {
    const id = (0,_breakout_rooms_50756495_js__WEBPACK_IMPORTED_MODULE_3__.p)(participant);
  ...
  getParticipants(search) {
    const allParticipants = (0,_breakout_rooms_50756495_js__WEBPACK_IMPORTED_MODULE_3__.g)(this.meeting);
    this.participantsToShow = allParticipants.filter((participant) => {
      var _a;
      return (this.participantIds.includes((0,_breakout_rooms_50756495_js__WEBPACK_IMPORTED_MODULE_3__.p)(participant)) &&
