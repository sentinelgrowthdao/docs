...
/* harmony import */ var _notification_a0736e4b_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(68008);
/* harmony import */ var _string_274004ff_js__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(1821);
/* harmony import */ var _breakout_rooms_50756495_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(55524);
/* harmony import */ var _flags_fc3b9ebe_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(81195);
...
const DyteNotifications = class {
  ...
  meetingChanged(meeting, oldMeeting) {
    ...
    if (meeting == null)
      return;
    const isLivestream = meeting.meta.viewType === 'LIVESTREAM';
    this.audio = new _notification_a0736e4b_js__WEBPACK_IMPORTED_MODULE_12__.D(meeting);
    ...
    this.participantJoinedListener = (participant) => {
      if (notifications.participant_joined) {
        this.add({
          ...
          message: `${(0,_string_274004ff_js__WEBPACK_IMPORTED_MODULE_18__.f)(participant.name)} ${this.t('notifications.joined')}`,
    ...
    this.participantLeftListener = (participant) => {
      if (notifications.participant_left) {
        this.add({
          ...
          message: `${(0,_string_274004ff_js__WEBPACK_IMPORTED_MODULE_18__.f)(participant.name)} ${this.t('notifications.left')}`,
          image: participant.picture,
    ...
    this.waitlistedParticipantJoinedListener = (participant) => {
      ...
      this.add({
        id,
        message: `${(0,_string_274004ff_js__WEBPACK_IMPORTED_MODULE_18__.f)(participant.name)} ${this.t('notifications.requesting_to_join_meeting')}`,
        image: participant.picture,
    ...
    (_e = meeting.remote) === null || _e === void 0 ? void 0 : _e.addListener('remoteUpdate', this.onRemoteUpdate);
    (_f = meeting.meta) === null || _f === void 0 ? void 0 : _f.addListener('activeTabUpdate', this.activeTabUpdateListener);
    (_g = meeting.recording) === null || _g === void 0 ? void 0 : _g.addListener('recordingUpdate', this.onRecordingUpdate);
    (_h = meeting.stage) === null || _h === void 0 ? void 0 : _h.addListener('stageRequestApproved', this.stageRequestAccepted);
    (_j = meeting.stage) === null || _j === void 0 ? void 0 : _j.addListener('stageRequestRejected', this.stageRequestRejected);
    if (meeting.self.permissions.stageEnabled && meeting.self.permissions.acceptStageRequests) {
      (_k = meeting.stage) === null || _k === void 0 ? void 0 : _k.addListener('newStageRequest', this.newStageRequests);
    }
  }
